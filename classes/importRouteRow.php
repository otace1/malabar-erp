	...
	<td class=" <?php echo $bg;?>" style="border: 1px solid black; text-align: left;">
		<input type="text" style="width: 15em;" name="fournisseur_<?php echo $compteur;?>" value="<?php echo $reponse['fournisseur'];?>">
	</td>
	<td class=" <?php echo $bg;?>" style="border: 1px solid black; text-align: left;">
	...
	<td class=" <?php echo $bg;?>" style="border: 1px solid black; text-align: center;">
		<input type="date" style="width: 15em;" name="amicongo_arriv_<?php echo $compteur;?>" value="<?php echo $reponse['amicongo_arriv'];?>">
	</td>
	<td class=" <?php echo $bg;?>" style="border: 1px solid black; text-align: center;">
		<input type="date" style="width: 15em;" name="insp_receiv_<?php echo $compteur;?>" value="<?php echo $reponse['insp_receiv'];?>">
	</td>
	<td class=" <?php echo $bg;?>" style="border: 1px solid black; text-align: center;">
		<input type="text" style="width: 5em; text-align: center;" name="ir_<?php echo $compteur;?>" value="<?php echo $reponse['ir'];?>">
	</td>
	<td class=" <?php echo $bg;?>" style="border: 1px solid black; text-align: center;">
