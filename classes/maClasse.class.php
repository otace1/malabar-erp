	...
	class maClasse{
		...
		public function creerDossierIB($ref_dos, $id_cli, $ref_fact, $fob, 
			...
			$requete-> execute(array($entree['ref_dos'], $entree['id_cli'], $entree['ref_fact'], 
									...
									$entree['supplier'], $entree['temporelle']));
		...
		public function afficherEnTeteTableau($id_mod_lic, $id_cli, $id_mod_trans){
			...
			if ($_SESSION['id_role'] != '7' && $_SESSION['id_role'] != '8') {
		...
		public function afficherSearchFile($mot_cle, $id_mod_lic){
			include("connexion.php");
			...
			$compteur = 0;
			$ligne = '';
			$requete = $connexion-> prepare("SELECT DATE_FORMAT(d.date_preal, '%d/%m/%Y') AS date_preal,
													DATE_FORMAT(d.klsa_arriv, '%d/%m/%Y') AS klsa_arriv, 
													cli.nom_cli AS nom_cli,
													d.id_dos AS id_dos,
													d.ref_dos AS ref_dos,
		...
		public function afficherRowTableau3($id_mod_lic, $id_cli, $id_mod_trans, $id_dos, $compteur){
			include('connexion.php');
			$entree['id_mod_lic'] = $id_mod_lic;
			$entree['id_cli'] = $id_cli;
			$entree['id_mod_trans'] = $id_mod_trans;
		...
		public function afficherLicence($id_mod_lic, $id_cli, $id_type_lic, $premiere_entree, $nombre_dossier_par_page){
			...
			?>
				...
				?>
					...
					<td style="text-align: center; border: 1px solid black;">
						<a title="Dossiers affectés" href="#" style="color: black;" onclick="window.open('popUpDossierLicence.php?num_lic=<?php echo $reponse['num_lic'];?>&couleur=<?php echo $couleur;?>','pop1','width=1300,height=900');">
		...
		public function getNbreMcaFile($id_cli, $id_mod_trans, $id_mod_lic){
			...
			$requete = $connexion-> prepare("SELECT COUNT(id_dos) AS nbre 
												...
												WHERE id_cli = ?
													...
													$sqlIdMarch
													AND ref_dos LIKE ?");
			$requete-> execute(array($entree['id_cli'], $entree['id_mod_trans'], $entree['id_mod_lic'], $entree['masque_date']));
			$reponse=$requete-> fetch();
			if($reponse){
				return $reponse['nbre'];
			}else{
