...
class nuts {
  ...
  private $units =
      array(
        "USD" => array(
          100,
          "fr-FR" => array('Dollar Américain', 'Dollars Américain', 'centime', 'centimes', '', ''),
          "pt-PT" => array('Dollar Américain', 'Dollars Américain', 'cêntimo', 'cêntimos', 'm', 'm'),
        ...
        "CDF" => array(
          100,
          "fr-FR" => array('Franc congolais', 'Francs congolais', 'centime', 'centimes', '', ''),
          "pt-PT" => array('Franc congolais', 'Francs congolais', 'cêntimo', 'cêntimos', 'm', 'm'),
          "en-EN" => array('Franc congolais', 'Francs congolais', 'cent', 'cents', '', '')
        )
      );
  private $numbers =
      array(
        "fr-FR" => array(
          ...
          1 => array('dix', 'vingt', 'trente', 'quarante', 'cinquante', 'soixante', 'septante', 'quatre-vingts', 'nonante'),
          2 => array('cent', 'cents'),
