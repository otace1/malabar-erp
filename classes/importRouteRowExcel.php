	<td class=" <?php echo $bg;?>" style="border: solid black; ">
	...
	<td class=" <?php echo $bg;?>" style="border: solid black; text-align: right;">
	...
	<td class=" <?php echo $bg;?>" style="border: solid black; text-align: left;">
	...
	<td class=" <?php echo $bg;?>" style="border: solid black; text-align: center;">
