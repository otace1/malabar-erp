            ...
            <div class="card">
              <div class="card-header">
                <h5><i class="fa fa-folder-open nav-icon"></i> 
                  <?php 
                    echo $maClasse-> getDepense($_GET['id_dep'])['nom_dep'].' Pending Invoicing';
                  ?>
                </h5>
              ...
              <div class="card-body table-responsive p-0">
                <table id="depense_pending_invoicing" cellspacing="0" width="100%" class="table table-bordered table-striped table-sm small text-nowrap">
                  <thead>
                    <th>#</th>
                    <th>MCA File Ref.</th>
                    <th>Client Name</th>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5><i class="fa fa-folder-open nav-icon"></i> 
                  <?php 
                    echo $maClasse-> getDepense($_GET['id_dep'])['nom_dep'].' Invoiced';
                  ?>
                </h5>
              ...
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0">
                <table id="depense_invoiced" cellspacing="0" width="100%" class="table table-bordered table-striped table-sm small text-nowrap">
                  <thead>
                    <th>#</th>
                    <th>MCA File Ref.</th>
                    <th>PO Ref.</th>
      ...
      // "responsive": true,
        "ajax":{
          ...
          "data": {
              ...
              "id_dep": "<?php echo $_GET['id_dep'];?>",
              "id_mod_lic": "<?php echo $_GET['id_mod_lic'];?>",
              "operation": "depense_pending_invoicing"
          }
        },
        "columns":[
          {"data":"compteur"},
