...
<html>
	...
	<body>
		<div id="">
		<table id="exportationExcelPretApurement" summary="Code page support in different versions of MS Windows."
        rules="groups" frame="hsides" cellspacing="0" cellpadding="4" border="1" style="text-align:center; display: none;">
          ...
          DOSSIERS PRETS POUR APUREMENT LICENCE <?php echo $_GET['num_lic'];?>
        </th>
			</tr>
            <tr>
        ...
        <tbody>
          <?php
            $maClasse-> afficherDossierLicencePretAppurementExcel($_GET['num_lic']);
          ?>
        </tbody>
    </table>
</div>
