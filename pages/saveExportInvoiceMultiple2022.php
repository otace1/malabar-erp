...
// if(!is_dir('../facture_dossier')){
// 	mkdir("../facture_dossier", 0777);
// }

// $facture_dossier= '../facture_dossier/'.$ref_fact;

// if(!is_dir($dossierfacture_dossier)){
// 	mkdir("../facture_dossier/$ref_fact", 0777);
// }
