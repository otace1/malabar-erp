            ...
            <div class="card">
              <div class="card-header">
                <h5><i class="fa fa-folder-open nav-icon"></i> 
                  <?php 
                  if ($_GET['statut']=='Dossiers En Cours') {
                  ...
                  }else if ($_GET['statut']=='Dossiers non declarés') {
                    if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='ENG') {
                      echo 'Files Awaiting Declaration';
                    }else if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='FR') {
                      echo 'Dossiers non declarés';
                    }
                  }else if ($_GET['statut']=='Dossiers Declarés Non Liquidés') {
                    if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='ENG') {
                      echo 'Files Awaiting Liquidation';
                    }else if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='FR') {
                      echo 'Dossiers Declarés Non Liquidés';
                    }
                  }else if ($_GET['statut']=='Dossiers En Attente Quittance') {
                    if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='ENG') {
      ...
      "responsive": true,
        "ajax":{
          ...
          "data": {
              ...
              "operation": "popUpOperations"
          }
        },
        <?php
          if ($_GET['statut']=='Dossiers En Cours' || $_GET['statut']=='Dossiers non declarés' || $_GET['statut']=='Dossiers Declarés Non Liquidés' || $_GET['statut']=='Dossiers En Attente Quittance'){
            ?>
        "columns":[
          {"data":"compteur"},
          {"data":"ref_dos"},
