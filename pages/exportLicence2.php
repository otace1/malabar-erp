...
$indiceSheet = 0;
	...
	for ($annee=$anneeDebut; $annee >= $anneeFin; $annee--) { 
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'FOB_LICENSE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'FREIGHT_LICENSE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'INSURANCE_LICENSE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'OTHER_CHARGE_LICENSE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'CIF_LICENSE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'FREIGHT_FILE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'INSURANCE_FILE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		$excel-> getActiveSheet()
			-> setCellValue($col.$row, 'OTHER_CHARGE_FILE');
		cellColor($col.$row, '000000');
		alignement($col.$row);
		...
		while ($reponse = $requete-> fetch()) {
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['fournisseur']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['cod_lic']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['fret']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['assurance']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['autre_frais']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, '=SUM(H'.$row.':K'.$row.')');
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['fsi']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['aur']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['fob_dos']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['fret_dos']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['assurance_dos']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, $reponse['autre_frais_dos']);
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
			...
			$excel-> getActiveSheet()
				-> setCellValue($col.$row, '=S'.$row.'+SUM(V'.$row.':X'.$row.')');
			cellColor($col.$row, $couleur);
			alignement($col.$row);
			// $excel->getActiveSheet()
			// 	->getStyle($col.$row)->applyFromArray($styleHeader);
