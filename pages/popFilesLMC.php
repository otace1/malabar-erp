...
?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5>LMC | Loading Date Between <?php echo $_GET['debut']?> and <?php echo $_GET['fin']?></h5>
              </div>    
              <!-- /.card-header -->
              <div class="card-body table-responsive">
                
                <table id="dossier_lmc_dashboard" class="table table-bordered table-hover  table-sm small">
                  <thead>
                    <tr class="">
  ...
  ?>
    ...
    $('#spinner-div').show();
    $('#dossier_lmc_dashboard').DataTable({
       lengthMenu: [
          [10, 20, 50, -1],
          [10, 20, 50, 500, 'All'],
      ],
    ...
    // "responsive": true,
      "ajax":{
        ...
        "data": {
            ...
            "operation": "dossier_lmc_dashboard"
        }
      },
      "columns":[
        {"data":"compteur"},
