...
$detail_facture_note = $maClasse-> detail_facture_service($_GET['ref_fact']);

$totalAll = $maClasse-> getTotalFactureService($_GET['ref_fact'], $sceau);

$total = $maClasse-> getTotalForFacturePartielle($_GET['ref_fact']);
$arsp = $maClasse-> getARSPForFacturePartielle($_GET['ref_fact']);

$taux =  number_format($maClasse-> getDataFactureGlobale($_GET['ref_fact'])['taux'], 4, ',', '.');
...
$tbl = <<<EOD
	...
	<table>
		...
		<tr>
			...
			<td width="6%" style="font-weight: bold; border: 1px solid black; background-color: rgb(220,220,220);text-align: center;">Appl.	</td>
			<td width="11%" style="font-weight: bold; border: 1px solid black; background-color: rgb(220,220,220);text-align: center;">Unit</td>
