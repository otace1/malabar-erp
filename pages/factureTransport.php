  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="header">
          <h5>
            <i class="fa fa-calculator nav-icon"></i> NEW TRANSPORT INVOICE
          </h5>
        </div>
...
<!-- <form method="POST" id="enregistrerFactureImportMMGAcid_form" action="" data-parsley-validate enctype="multipart/form-data"> -->
  ...
  <div class="card-body">
    ...
    <div class="row">
      ...
      <input type="hidden" name="id_mod_fact" id="id_mod_fact" value="10">
      <div class="col-md-3">
...
<script type="text/javascript">
  ...
  function closeAndSave(ref_fact){
    ...
    if(confirm('Do really you want to close and save ?')) {
      ...
      window.open('viewFactureTransport.php?ref_fact='+ref_fact,'pop1','width=1000,height=800');
