                    ...
                    <div class="card-body">
                        <div class="row">
                          <div class="col-sm-12">
                              ...
                              <input type="hidden" name="nbre" value="<?php echo $maClasse-> nbreSummaryStatus($_GET['statut'], $_GET['id_mod_lic'], $_GET['id_cli'], $_GET['id_mod_trans'], $_GET['commodity']);?>">
                              <td class="col_1">
                              ...
                              <table id="user_data_2" cellspacing="0" width="100%" class="tableau-de-donnees table-dark table table-hover text-nowrap table-sm">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $maClasse-> afficherRowDossierClientModeTransportModeLicenceStatusAuto($_GET['id_cli'], 
