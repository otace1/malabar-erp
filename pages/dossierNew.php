            ...
            <div class="card">
              <div class="card-header">
                ...
                <button class="btn btn-info square-btn-adjust" data-toggle="modal" data-target=".nouveauDossierExport" <?php echo $maClasse-> getDataUtilisateur($_SESSION['id_util'])['tracking_enab']?>>
                  ...
                  <button class="btn btn-info square-btn-adjust" onclick="window.location.replace('nouveauDossier.php?id_cli=<?php echo $_GET['id_cli'];?>&id_mod_trac=<?php echo $_GET['id_mod_trac'];?>&id_mod_trans=<?php echo $_GET['id_mod_trans'];?>&commodity=<?php echo $_GET['commodity'];?>&statut=<?php echo $_GET['statut'];?>&id_march=<?php echo $_GET['id_march'];?>');" <?php echo $maClasse-> getDataUtilisateur($_SESSION['id_util'])['tracking_enab']?>>
                      <i class="fa fa-plus"></i> Nouveau Dossier
                  </button>
                    <?php
                  }
