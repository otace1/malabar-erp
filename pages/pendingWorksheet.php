  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="header">
          <h5><i class="fa fa-exclamation-triangle nav-icon"></i>
            <?php
              if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='ENG') {
                echo 'Pending Files | '.$maClasse-> getNomClient($_GET['id_cli']);
              }else if ($maClasse-> getUtilisateur($_SESSION['id_util'])['langue']=='FR') {
                echo 'Dossiers En attente | '.$maClasse-> getNomClient($_GET['id_cli']);
              }
            ?>
          </h5>
        </div>
