            ...
            <div class="card">   
              ...
              <div class="card-body table-responsive p-0">
                <table id="client_note_debit" cellspacing="0" width="100%" class="table table-bordered table-striped table-sm text-nowrap table-hover table-dark">
                  ...
                  <tbody id="afficherDossierNewNoteDebitCEECImpala">
...
$(document).ready(function(){
  afficherDossierNewNoteDebitCEECImpala();
});

function afficherDossierNewNoteDebitCEECImpala(){
  $('#spinner-div').show();
  $.ajax({
    type: 'post',
    url: 'ajax.php',
    data: {id_mod_lic: <?php echo $_GET['id_mod_lic'];?>, id_cli: <?php echo $_GET['id_cli'];?>, id_dep: <?php echo $_GET['id_dep'];?>, operation: 'afficherDossierNewNoteDebitCEECImpala'},
    dataType: 'json',
    success:function(data){
      if (data.logout) {
        ...
        $('#afficherDossierNewNoteDebitCEECImpala').html(data.afficherDossierNewNoteDebitCEECImpala);
            ...
            $.ajax({
              ...
              success:function(data){
                if (data.logout) {
                  ...
                  window.open('viewNoteDebitCEECImpala.php?ref_note='+fd.get('ref_note'),'pop1','width=1000,height=800');
