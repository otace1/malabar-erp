...
?>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive">
                ...
                <table id="dossier_loading_dashboard" class="table table-bordered table-hover table-responsive table-sm small">
                  <thead>
                    <tr class="">
  ...
  ?>
    ...
    $('#spinner-div').show();
    $('#dossier_loading_dashboard').DataTable({
       lengthMenu: [
          [10, 20, 50, -1],
          [10, 20, 50, 500, 'All'],
      ],
        ...
        'pageLength',
          {
            ...
            title: 'Loading_report_between_<?php echo $_GET['debut'];?>_and_<?php echo $_GET['fin'];?>',
    ...
    // "responsive": true,
      "ajax":{
        ...
        "data": {
            ...
            "operation": "dossier_loading_dashboard"
        }
      },
      "columns":[
        {"data":"compteur"},
