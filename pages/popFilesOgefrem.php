...
?>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5>OGEFREM | Loading Date Between <?php echo $_GET['debut']?> and <?php echo $_GET['fin']?></h5>
              </div>    
              <!-- /.card-header -->
              <div class="card-body table-responsive">
                
                <table id="dossier_ogefrem_dashboard" class="table table-bordered table-hover  table-sm small">
                  <thead>
                    <tr class="">
                      ...
                      <th>Client Invoiced_Date</th>
                      <th>Qty</th>
                      <th>RUBRIQUES (Category)</th>
  ...
  ?>
    ...
    $('#spinner-div').show();
    $('#dossier_ogefrem_dashboard').DataTable({
       lengthMenu: [
          [10, 20, 50, -1],
          [10, 20, 50, 500, 'All'],
      ],
    ...
    // "responsive": true,
      "ajax":{
        ...
        "data": {
            ...
            "operation": "dossier_ogefrem_dashboard"
        }
      },
      "columns":[
        {"data":"compteur"},
