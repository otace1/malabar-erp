...
if (isset($_POST['updateMultipleFiles'])) {
  ...
  $maClasse->updateMultipleFilesExport(
    $_POST['debut'],
    $_POST['fin'],
    $_GET['id_cli'],
    $_GET['id_mod_trans'],
            ...
            <div class="card-header">
              <h3 class="card-title" style="font-weight: bold;">
                      ...
                      for ($i = 1; $i <= $_POST['nbre']; $i++) {
                        ...
                        if (isset($_POST['ref_dos_' . $i]) && ($_POST['ref_dos_' . $i] != '') && isset($_POST['num_lic_' . $i]) && ($_POST['num_lic_' . $i] != '') && isset($_POST['num_lot_' . $i]) && ($_POST['num_lot_' . $i] != '')) {
                          ...
                          $maClasse->creerDossierEBAMC(
                            ...
                            $_POST['trailer_2_' . $i],
                            $_POST['site_load_' . $i],
                            $_POST['destination_' . $i],
                            $_POST['barge_' . $i],
                            $_POST['nbr_bags_' . $i],
                            $_POST['poids_' . $i],
                            $_POST['kapulo_load_' . $i],
                            $_POST['ship_num_' . $i]
                          );
                        }
                      }
                      ...
                      for ($i = 1; $i <= $_POST['nbre']; $i++) {
                        ...
                        if (isset($_POST['ref_dos_' . $i]) && ($_POST['ref_dos_' . $i] != '') && isset($_POST['num_lic_' . $i]) && ($_POST['num_lic_' . $i] != '') && isset($_POST['num_lot_' . $i]) && ($_POST['num_lot_' . $i] != '')) {
                          ...
                          $maClasse->creerDossierEB(
                            ...
                            $_POST['site_load_' . $i],
                            $_POST['destination_' . $i],
                            $_POST['transporter_' . $i],
                            $_POST['nbr_bags_' . $i],
                            $_POST['poids_' . $i],
                            $_POST['load_date_' . $i],
                            $_POST['dgda_seal_' . $i],
                            $_POST['container_' . $i],
                            $_POST['pied_container_' . $i]
                          );
                        }
                      }
                    }
                ...
                ?>
                  ...
                  if ($_GET['id_cli'] == 869 && $_GET['id_march'] != '19' && $_GET['id_march'] != '11' && $_GET['id_march'] != '25' && $_GET['id_march'] != '26' && $_SESSION['id_role'] != '7' && $_SESSION['id_role'] != '8' && $_SESSION['id_role'] != '9' && $_SESSION['id_role'] != '10') {
                  ?>
              ...
              <div class="card-tools">
                ...
                <button type="button" class="btn btn-xs small btn-success dropdown-toggle dropdown-icon" data-toggle="dropdown">
                  ...
                  <div class="dropdown-menu small" role="menu">
                    <a class="dropdown-item" onclick="window.location.replace('exportExcel2.php?id_cli=<?php echo $_GET['id_cli']; ?>&id_mod_trans=<?php echo $_GET['id_mod_trans']; ?>&id_mod_trac=<?php echo $_GET['id_mod_trac']; ?>&commodity=<?php echo $_GET['commodity']; ?>&statut=<?php echo $_GET['statut']; ?>&id_march=&annee=2026','pop1','width=80,height=80');">
                      Export All 2026 Files
                    </a>
                    <a class="dropdown-item" onclick="window.location.replace('exportExcel2.php?id_cli=<?php echo $_GET['id_cli']; ?>&id_mod_trans=<?php echo $_GET['id_mod_trans']; ?>&id_mod_trac=<?php echo $_GET['id_mod_trac']; ?>&commodity=<?php echo $_GET['commodity']; ?>&statut=<?php echo $_GET['statut']; ?>&id_march=<?php echo $_GET['id_march']; ?>&annee=2026','pop1','width=80,height=80');">
                      Export <?php echo $maClasse->getMarchandise($_GET['id_march']); ?> 2026 Files
                    </a>
                ...
                <table id="user_data_2" cellspacing="0" width="100%" class="tableau-de-donnees  table table-hover text-nowrap table-sm small">
                  ...
                  <tbody>
                    ...
                    if (isset($_POST['rech'])) {
                      ...
                      $maClasse->afficherRowDossierClientModeTransportModeLicence2Recherche(
                        $_POST['ref_dos'],
                        $_GET['id_cli'],
                        $_GET['id_mod_trans'],
                        $_GET['id_mod_trac'],
                    ...
                    ?>
                      <tr>
                        <td class="col_1 bg-teal">
                          <hr>
                        </td>
                        <td class="col_6 bg-teal">
                          <hr>
                        </td>
                        <td>
                          <hr>
                    ...
                    $maClasse->afficherRowDossierClientModeTransportModeLicence2(
                      $_GET['id_cli'],
                      $_GET['id_mod_trans'],
                      $_GET['id_mod_trac'],
                      $_GET['commodity'],
...
<?php
if (isset($_GET['id_mod_trac']) && ($_GET['id_mod_trac'] == '2' && $_GET['id_cli'] != '869') || ($_GET['id_mod_trac'] == '2' && $_GET['id_march'] == '11') || ($_GET['id_mod_trac'] == '2' && $_GET['id_march'] == '19') || ($_GET['id_mod_trac'] == '2' && $_GET['id_march'] == '25') || ($_GET['id_mod_trac'] == '2' && $_GET['id_march'] == '26')) {
...
<?php
} else if ($_GET['id_mod_trac'] == '2' && $_GET['id_cli'] == '869' && $_GET['id_march'] != '11' && $_GET['id_march'] != '19') {
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <select name="debut" onchange="" class="form-control cc-exp">
                  <?php
                  $maClasse->selectionnerDossierClientModeTransportModeLicence2(
                    $_GET['id_cli'],
                    $_GET['id_mod_trans'],
                    $_GET['id_mod_trac'],
                    $_GET['commodity']
  ...
  function get_licence_for_excel_tracking(mot_cle = null) {
    ...
    $.ajax({
      ...
      data: {
        ...
        commodity: "<?php echo $_GET['commodity']; ?>",
        statut: "<?php echo $_GET['statut']; ?>",
        id_march: "<?php echo $_GET['id_march']; ?>",
        operation: 'licence_for_excel_tracking'
      },
      dataType: "json",
      success: function(data) {
        if (data.logout) {
    ...
    if ($('#horse').val() === null && $('#horse').val() === '') {} else {
      ...
      $.ajax({
        ...
        data: {
          ...
          trailer_1: trailer_1,
          trailer_2: trailer_2,
          road_manif: road_manif,
          operation: 'check_camion'
        },
        dataType: "json",
        success: function(data) {
          if (data.logout) {
