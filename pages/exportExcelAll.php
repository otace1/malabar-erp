...
while ($reponseModeTransport = $requeteModeTransport-> fetch()) {
	...
	if ($_GET['id_mod_trac'] == '1' && $_GET['id_march'] != '18' && $_GET['id_cli'] != '876' && $_GET['id_cli'] != '878') {
		...
		while ($reponseLicence = $requeteLicence-> fetch()) {
			...
			$requete = $connexion-> prepare("SELECT d.ref_dos AS ref_dos,
												...
												WHERE d.id_cli =  cl.id_cli
													...
													$sql1
												$sqlOrder");
			$requete-> execute(array($entree['id_cli'], $entree['id_mod_trans'], $entree['id_mod_lic'], $reponseLicence['num_lic'], NULL));
			while ($reponse = $requete-> fetch()) {
				$compteur++;
				$bg = "";
	...
	//GLOBAL SUMMARY POUR IMPORT ROUTE
		...
		if ($reponseModeTransport['id_mod_trans']=='1' && $_GET['id_mod_trac'] != '1') {
			...
			$excel-> getActiveSheet()
				-> setCellValue('C5', 'AT WISKI')
				-> setCellValue('D5', $maClasse-> getNbreDossierCancelledAwaitingCRFAtWiski($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('C6', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D6', $maClasse-> getNbreDossierCancelledAwaitingCRFDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('C7', 'EXCEPTED TO ARRIVE')
				-> setCellValue('D7', $maClasse-> getNbreDossierCancelledAwaitingCRFExceptedToArrival($_GET['id_cli'], NULL));
			...
			$excel-> getActiveSheet()
				-> setCellValue('C8', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D8', $maClasse-> getNbreDossierCancelledAwaitingAssuranceDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('C9', 'EXCEPTED TO ARRIVE')
				-> setCellValue('D9', $maClasse-> getNbreDossierCancelledAwaitingAssuranceExceptedToArrival($_GET['id_cli'], NULL));
			...
			$excel-> getActiveSheet()
				-> setCellValue('C11', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D11', $maClasse-> getNbreDossierClearedAwaitingBAEDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B12', 'AWAITING CRF');
			$excel-> getActiveSheet()
				-> setCellValue('C12', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D12', $maClasse-> getNbreDossierClearedAwaitingCRFDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B13', 'AWAITING INSURANCE');
			$excel-> getActiveSheet()
				-> setCellValue('C13', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D13', $maClasse-> getNbreDossierClearedAwaitingAssuranceDispatchFromKlsa($_GET['id_cli'], NULL));
			...
			$excel-> getActiveSheet()
				-> setCellValue('C14', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D14', $maClasse-> getNbreDossierClearedCompletedDispatchFromKlsa($_GET['id_cli'], NULL));
			$excel-> getActiveSheet()
				-> setCellValue('C15', 'EXCEPTED TO ARRIVE')
				-> setCellValue('D15', $maClasse-> getNbreDossierClearedCompletedCRFExceptedToArrival($_GET['id_cli'], NULL));
			...
			$excel-> getActiveSheet()
				-> setCellValue('C17', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D17', $maClasse-> getNbreDossierTransitAwaitingBAEDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B18', 'AWAITING CRF');
			$excel-> getActiveSheet()
				-> setCellValue('C18', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D18', $maClasse-> getNbreDossierTransitAwaitingCRFDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B19', 'AWAITING CRF');
			$excel-> getActiveSheet()
				-> setCellValue('C19', 'EXCEPTED TO ARRIVE')
				-> setCellValue('D19', $maClasse-> getNbreDossierClearedTransitCRFExceptedToArrival($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B20', 'AWAITING INSURANCE');
			$excel-> getActiveSheet()
				-> setCellValue('C20', 'AT WISKI')
				-> setCellValue('D20', $maClasse-> getNbreDossierTransitAwaitingAssuranceAtWiski($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B21', 'AWAITING INSURANCE');
			$excel-> getActiveSheet()
				-> setCellValue('C21', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D21', $maClasse-> getNbreDossierTransitAwaitingAssuranceDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B22', 'AWAITING INSURANCE');
			$excel-> getActiveSheet()
				-> setCellValue('C22', 'EXCEPTED TO ARRIVE')
				-> setCellValue('D22', $maClasse-> getNbreDossierTransitAwaitingAssuranceExceptedToArrive($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B23', 'AWAITING QUITTANCE');
			$excel-> getActiveSheet()
				-> setCellValue('C23', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D23', $maClasse-> getNbreDossierClearedAwaitingQuittanceDispatchFromKlsa($_GET['id_cli'], NULL));

			$excel-> getActiveSheet()
				-> setCellValue('B24', 'CLEARING COMPLETED');
			$excel-> getActiveSheet()
				-> setCellValue('C24', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D24', $maClasse-> getNbreDossierTransitClearedCompletedDispatchFromKlsa($_GET['id_cli'], NULL));
			...
			$excel-> getActiveSheet()
				-> setCellValue('C25', 'DISPATCHED FROM K\'LSA')
				-> setCellValue('D25', $maClasse-> getNbreDossierTransitUnderPreparationDispatchFromKlsa($_GET['id_cli'], NULL));
			$excel-> getActiveSheet()
				-> setCellValue('C26', 'EXCEPTED TO ARRIVE')
				-> setCellValue('D26', $maClasse-> getNbreDossierTransitExceptedToArrival($_GET['id_cli'], NULL));
		...
		$requete = $connexion-> prepare("SELECT d.ref_dos AS ref_dos,
											...
											WHERE d.id_cli =  cl.id_cli
												...
												$sql1
											$sqlOrder");
		$requete-> execute(array($entree['id_cli'], $entree['id_mod_trans'], $entree['id_mod_lic'], NULL));
		while ($reponse = $requete-> fetch()) {
			$compteur++;
			$bg = "";
