   ...
   <!--  <form action="" method="POST" id="form_df">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title"><i class="fa fa-list"></i> Request Payment Detail <button class="btn btn-xs btn-primary" title="Print" onclick="window.open('generateur_demande_fond.php?id_df='+id_df_print.value+'&couleur=','pop1','width=500,height=700');"><i class="fa fa-print"></i></button> Print the Voucher</h5>
      ...
      success:function(data){
        if (data.logout) {
          ...
          if(data.decaiss_df=='1'){
            btn_decaiss_df = '<span class=\"btn btn-xs btn-success\"\" onclick=\"modal_decaiss_df('+data.id_df+')\"><i class=\"fa fa-check\"></i></span> Make the Payment';
          }
