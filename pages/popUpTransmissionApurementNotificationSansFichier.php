          ...
          <div class="col-12">
              ...
              <!-- /.card-header -->
                  <div class="card card-<?php echo $couleur;?>">
                    <div class="card-header">
                      <h3 class="card-title">
                        <i class="fa fa-folder-open nav-icon"></i> DETAIL TRANSMISSION APUREMENT SANS ACCUSEE DE RECEPTION <?php echo $client;?>
                          ...
                          <div class="col-sm-12">
                            <div class="card-body table-responsive p-0" style="height: 800px;">
                              <table class="table table-dark  table-head-fixed table-bordered table-hover text-nowrap table-sm">
                                ...
                                <tbody>
                                  <?php
                                    $maClasse-> afficherApurementSansFichier($_GET['id_cli'], $_GET['id_mod_lic'], 0, 100000);
                                  ?>
                                </tbody>
                              </table>
                            </div>
