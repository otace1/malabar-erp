    ...
    $('#spinner-div').show();
      $('#file_data').DataTable({
        ...
        buttons: [
            ...
            {
              extend: 'pageLength',
              text: '<i class="fa fa-list"></i> Lignes',
              className: 'btn btn-dark'
            },
            {
              extend: 'colvis',
              text: '<i class="fa fa-table"></i> Colonnes',
              className: 'btn btn-info'
            }
        ],
        "language": {
            "lengthMenu": "Afficher _MENU_ records per page",
            "zeroRecords": "Aucune donnees trouvees",
            "info": "Apercu page _PAGE_ sur _PAGES_",
