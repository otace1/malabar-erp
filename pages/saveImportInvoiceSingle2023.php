...
if ( ($maClasse-> getFactureGlobale($_POST['ref_fact'])['validation']) == '0' ) {
	...
	if (!empty($maClasse-> getDataUtilisateur($maClasse-> getFactureGlobale($_POST['ref_fact'])['id_util_validation'])['signature_facture'])) {
		$sceau = '<img src="../images/signature_facture/'.$maClasse-> getDataUtilisateur($maClasse-> getFactureGlobale($_POST['ref_fact'])['id_util_validation'])['signature_facture'].'" width="'.$maClasse-> getDataUtilisateur($maClasse-> getFactureGlobale($_POST['ref_fact'])['id_util_validation'])['size_signature_facture'].'">';
	}
...
$taxe = $maClasse-> getDetailFactureImportSingle2023($_POST['ref_fact'], '1');

$autres_charges = $maClasse-> getDetailFactureImportSingle2023($_POST['ref_fact'], '2');

$operational_cost = $maClasse-> getDetailFactureImportSingle2023($_POST['ref_fact'], '3');

$service_fee = $maClasse-> getDetailFactureImportSingle2023($_POST['ref_fact'], '4');

$totalAll = $maClasse-> getTotalFactureImportSingle2023($_POST['ref_fact'], $sceau);
...
$num_tva = $maClasse-> getClient($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['id_cli'])['num_tva'];
...
$truck = $maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['truck'];
...
$num_exo = $maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['num_exo'];
$poids = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['poids'], 2, ',', '.');
$fob_usd = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['fob_usd'], 2, ',', '.');
$fret_usd = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['fret_usd'], 2, ',', '.');
$autre_frais_usd = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['autre_frais_usd'], 2, ',', '.');
$assurance_usd = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['assurance_usd'], 2, ',', '.');
...
$code_tarif = $maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['code_tarif'];
...
$cif_usd = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['cif_usd'], 2, ',', '.');
$cif_cdf = number_format($maClasse-> getDataDossiersMultipleInvoice($_POST['ref_fact'])['cif_cdf'], 2, ',', '.');
...
iif ($facture['id_cli']==878 || $facture['id_cli']==876) {
	$banque = '<tr>
					<td width="10%" style="border-top: 1px solid black; border-left: 1px solid black; text-align: left;  font-size: 7px;">&nbsp;INTITULE</td>
...
}else if ($facture['id_cli']==864 || $facture['id_cli']==899 || $facture['id_cli']==916 || $facture['id_cli']==906 || $facture['id_cli']==901 || $facture['id_cli']==932 || $facture['id_cli']==856|| $facture['id_cli']==923 || $facture['id_cli']==905) {
	$banque = '<tr>
					<td width="10%" style="border-top: 1px solid black; border-left: 1px solid black; text-align: left;  font-size: 7px;">&nbsp;INTITULE</td>
					<td width="35%" style="border-top: 1px solid black; border-right: 1px solid black;  font-size: 7px;">&nbsp;MALABAR RDC SARL</td>
					<td width="10%"></td>
...
$tbl = <<<EOD
	...
	<table>
		...
		<tr>
			<td width="49%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220); text-align: center;">&nbsp;<u>Description</u></td>
			<td width="9%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">Unit</td>
			<td width="8%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">%</td>
			<td width="11%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">Rate/CDF</td>
			<td width="11.5%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">VAT/CDF</td>
			<td width="11.5%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">Total/CDF</td>
		</tr>
		$taxe
		<tr>
			<td colspan="4"></td>
		...
		<tr>
			<td width="49%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220); text-align: center;">&nbsp;<u>Description</u></td>
			<td width="9%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">Unit</td>
			<td width="8%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">Qty</td>
			<td width="11%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">Taux/USD</td>
			<td width="11.5%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">TVA/USD</td>
			<td width="11.5%" style="font-weight: bold; border: 1px solid black; font-size: 7px; background-color: rgb(220,220,220);text-align: center;">TOTAL  EN USD</td>
		</tr>
		$autres_charges
		<tr>
			<td width="100%"></td>
