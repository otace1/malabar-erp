...
<form method="POST" id="enregistrerFactureImportMMGAcid_form" action="" data-parsley-validate enctype="multipart/form-data">
  <input type="hidden" name="operation" id="operation" value="enregistrerFactureImportMMGAcid">
    ...
    <div class="row">
      ...
      <div class="col-md-3">
          ...
          <div class="form-group">
            ...
            <select class="form-control form-control-sm" name="id_dos" id="id_dos" onchange="getTableauEMSExport(id_mod_fact.value, this.value, id_mod_lic.value, id_march.value, id_mod_trans.value, consommable.value)" required>
              <option></option>
              <?php
...
<script type="text/javascript">
  ...
  function getTableauEMSExport(id_mod_fact, id_dos, id_mod_lic, id_march, id_mod_trans, consommable){
    $('#spinner-div').show();
    $.ajax({
      type: "POST",
      url: "ajax.php",
      data: { id_mod_fact: id_mod_fact, id_dos: id_dos, id_mod_lic: id_mod_lic, id_march:id_march, id_mod_trans:id_mod_trans, consommable:consommable, operation: 'getTableauEMSExport'},
      dataType:"json",
      success:function(data){
        if (data.logout) {
          alert(data.logout);
  ...
  $(document).ready(function(){
      ...
      $('#enregistrerFactureImportMMGAcid_form').submit(function(e){
