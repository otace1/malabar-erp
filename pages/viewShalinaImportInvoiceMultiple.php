...
$dossiers = $maClasse-> getDossierFactureImportShalina($_GET['ref_fact']);
...
$tbl = <<<EOD
	...
	<table>
		...
		<tr>
			...
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Horse<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Trailer 1<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Trailer 2<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Container No.<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>PO Number<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Invoice No.<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Qty(Mt)<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold;"><span><br>Date de dispatch</span></td>
			<td width="5%" style=""></td>
		</tr>
		$dossiers
		<br>
