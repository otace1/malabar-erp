            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title" style="font-weight: bold;">
                  <i class="fa fa-object-group nav-icon"></i> GROUPS OF ACCOUNTS
                </h5>


                <div class="card-tools">
                  <div class="pull-right">
                      <button class="btn-xs btn-primary square-btn-adjust" data-toggle="modal" data-target=".newGroup">
                ...
                <table class=" table table-dark table-head-fixed table-bordered table-hover text-nowrap table-sm">
                  <thead>
                    <tr class="">
                      ...
                      <th style="">Name Of Group</th>
                      <th style=" text-align: center;">Category</th>
                      <th style=" text-align: center;">Action</th>
                    </tr>
                  </thead>
                  <tbody id="groups_account">
                    <?php
...
<div class="modal fade newGroup" id="newGroup">
  <div class="modal-dialog modal-md">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input name="nom_class" id="nom_class" class="form-control form-control-sm cc-exp">
          </div>

          <div class="col-md-6">
            <label for="x_card_code" class="control-label mb-1">Category</label>
            <select name="id_cat_cmpte" id="id_cat_cmpte" onchange="" class="form-control form-control-sm cc-exp">
              <option></option>
                <?php
      ...
      <div class="modal-footer justify-content-between">
        ...
        <button name="newGroup" class="btn-xs btn-primary" onclick="creerClasseCompte(nom_class.value, id_cat_cmpte.value);">Submit</button>
      </div>
    </div>
    <!-- </form> -->
    <!-- /.modal-content -->
...
<script type="text/javascript">
  ...
  function groups_account(){

    $.ajax({
      type: 'post',
      url: 'ajax.php',
      data: {operation: 'groups_account'},
      dataType: 'json',
      success:function(data){
        if (data.logout) {
          ...
          $('#groups_account').html(data.groups_account);
          // $('#spinner-div').hide();//Request is complete so hide spinner
        }
      }
    });
  ...
  function creerClasseCompte(nom_class, id_cat_cmpte){
    ...
    if(confirm('Do really you want to submit ?')) {
      ...
      $('#spinner-div').show();
       ...
       $.ajax({
        type: 'post',
        url: 'ajax.php',
        data: {nom_class: nom_class, id_cat_cmpte: id_cat_cmpte, operation: 'creerClasseCompte'},
        dataType: 'json',
        success:function(data){
          if (data.logout) {
            alert(data.logout);
