...
$taux = number_format($maClasse-> getFactureGlobale($_GET['ref_fact'])['taux'], 4, ',', '.');

$taxe = $maClasse-> getDetailFactureLicenceGlobalExport($_GET['ref_fact'], '1');
...
$totalAll = $maClasse-> getTotalFactureLicenceGlobalExport($_GET['ref_fact']);
...
$nbre_dos = $maClasse-> getNbreDossierLicence($maClasse-> getFactureGlobale($_GET['ref_fact'])['num_lic']);
...
$num_lic = $maClasse-> getFactureGlobale($_GET['ref_fact'])['num_lic'];
...
$tbl = <<<EOD
	...
	<table>
		...
		<tr>
			...
			<td width="18%" style="text-align: left; border: 0.3px solid black; font-size: 7px;">&nbsp;Numero Licence: </td>
		...
		<tr>
			<td width="15%" style="text-align: left; "></td>
			<td width="18%" style="text-align: left; border: 0.3px solid black; font-size: 7px;">&nbsp;Taux / Rate: </td>
