        ...
        <div class="row">
          <div class="col-12">
              ...
              <div class="card card-<?php echo $couleur;?>">
                <div class="card-header">
                  <h3 class="card-title">
                    <i class="fa fa-folder-open nav-icon"></i> DOSSIERS REGIME SUSPENSION <?php echo '<span class="bg bg-dark" style="padding-left: 5px; padding-right: 5px;">'.$client['nom_cli'].'</span>'.$marchandise.$mode_transport.$commodity.$licence.$statut.$cleared;?>
                          ...
                          <div class="card-body table-responsive p-0" style="height: 800px;">
                            <table class="table table-dark  table-head-fixed table-bordered table-hover text-nowrap table-sm">
                              ...
                              <tbody>
                                ...
                                <?php
                                  $maClasse-> afficherRegimeSuspensionSansDateExtreme($_GET['id_cli'], $_GET['id_mod_trans'], $_GET['id_mod_trac']);
                                ?>
                                </form>
                              </tbody>
                            </table>
