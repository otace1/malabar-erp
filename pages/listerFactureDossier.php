     ...
     $maClasse-> MAJ_validation_facture_dossier($_POST['ref_fact'], '1');
      ?>
        <div class="alert alert-success alert-dismissible" role="alert">
          ...
          <strong>Opération reussie!</strong> Facture <b><?php echo $_POST['ref_fact'];?></b> validée avec succès.
        </div>
      <?php
    }
    ...
    if( isset($_POST['transmissionFacture']) ){
     $maClasse-> MAJ_transmission_facture_dossier($_POST['ref_fact'], '1', $_SESSION['id_util']);
      ?>
        <div class="alert alert-success alert-dismissible" role="alert">
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <strong>Opération reussie!</strong> Facture <b><?php echo $_POST['ref_fact'];?></b> transmis avec succès.
        </div>
      <?php
    }
     ...
     $maClasse-> supprimerFactureDossier($_POST['ref_fact']);
      ?>
        <div class="alert alert-danger alert-dismissible" role="alert">
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <strong>Opération reussie!</strong> Facture <b><?php echo $_POST['ref_fact'];?></b> supprimer avec succès.
        </div>
      <?php
    }
