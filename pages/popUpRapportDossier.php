              ...
              <!-- /.card-header -->
                  <div class="card ">
                    <div class="card-header">
                      <h3 class="card-title">
                        <?php
                          echo $maClasse-> getDataColonne($_GET['id_col'])['titre_col'].' Between '.$_GET['debut'].' and '.$_GET['fin'];
                        ?>
                      </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="kpi_tracking_reportAll2" cellspacing="0" width="100%" class="table table-bordered table-striped table-sm small text-nowrap table-responsive p-0">
                          <thead>
                            <tr class="">
                              <?php
                              ...
                              <th style="text-align: center;">T1 Date</th>
...
<script type="text/javascript">
  ...
  $('#spinner-div').show();
  $('#kpi_tracking_reportAll2').DataTable({
     lengthMenu: [
        [25, 50, 100, 500, -1],
        [25, 50, 100, 500, 'All'],
    ],
  ...
  // "responsive": true,
    "ajax":{
      ...
      "data": {
          "operation": "kpi_tracking_reportAll2",
          "debut": "<?php echo $_GET['debut'];?>",
          "fin": "<?php echo $_GET['fin'];?>",
          "id_cli": "<?php echo $_GET['id_cli'];?>",
          "champ_col": "<?php echo $maClasse-> getDataColonne($_GET['id_col'])['champ_col'];?>",
