      ...
      <div class="container-fluid">
        <div class="header">
          ...
          <div class="float-right">
            <button class="btn btn-warning btn-sm" onclick="window.location.replace('file_pending_worksheet.php?id_cli=<?php echo $_GET['id_cli'];?>&id_mod_lic=<?php echo $_GET['id_mod_lic'];?>');"><i class="fa fa-exclamation-triangle"></i> Pending Files</button>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0 small">
                <table id="dossier_worsheet_waiting_validation" class=" table table-dark  table-bordered table-hover text-nowrap table-head-fixed table-sm">
                  <thead>
                    <tr class="bg ">
                      <th style="">#</th>
                      <th style="">Ref.Dossier</th>
          ...
          <div class="col-6">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0 small">
                <table id="dossier_worsheet_validated" class=" table table-dark table-bordered table-hover text-nowrap table-sm">
                  <thead>
                    <tr class="bg ">
                      <th style="">#</th>
                      <th style="">Ref.Dossier</th>
