    ...
    <section class="content">
      <div class="container-fluid" style="">
        <form id="form_creer_note_debit" method="POST" action="">
          ...
          <input type="hidden" name="id_model_nd" value="5">
        <div class="row">
          <div class="col-12">
            <div class="card">   
              <!-- /.card-header -->
                ...
                <div class="row">
                  <div class="col-md-3">
                      ...
                      <div class="form-group">
                        <label for="inputEmail3" class="col-form-label">Debit Note Ref.: </label>
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm bg bg-dark" name="libelle" id="libelle" value="" required></textarea>
                      </div>
            ...
            <div class="card">   
              ...
              <div class="card-body table-responsive p-0">
                <table id="client_note_debit" cellspacing="0" width="100%" class="table table-bordered table-striped table-sm text-nowrap table-hover table-dark">
                  ...
                  <tbody id="afficherDossierNewNoteDebitOther">
...
$(document).ready(function(){
  afficherDossierNewNoteDebitOther();
});

function afficherDossierNewNoteDebitOther(){
  $('#spinner-div').show();
  $.ajax({
    type: 'post',
    url: 'ajax.php',
    data: {id_mod_lic: <?php echo $_GET['id_mod_lic'];?>, id_cli: <?php echo $_GET['id_cli'];?>, id_dep: <?php echo $_GET['id_dep'];?>, operation: 'afficherDossierNewNoteDebitOther'},
    dataType: 'json',
    success:function(data){
      if (data.logout) {
        ...
        $('#afficherDossierNewNoteDebitOther').html(data.afficherDossierNewNoteDebitOther);
            ...
            $.ajax({
              ...
              success:function(data){
                if (data.logout) {
                  ...
                  window.open('viewNoteDebitTemplate.php?ref_note='+fd.get('ref_note'),'pop1','width=1000,height=800');
