...
$detail_note_debit = $maClasse-> getDetailNoteDebitTemplate($_GET['ref_note']);
$dossiers_note_debit = $maClasse-> get_dossiers_note_debit($_GET['ref_note']);
...
$tbl = <<<EOD
	...
	<table>
		...
		<tr>
			<td width="100%" style="text-align: left; font-size: 7px;">Le paiement doit s`effectuer endéans 7 jours.</td>
		</tr>
		<tr>
			<td width="100%"></td>
		</tr>
...
$tbl = <<<EOD
	...
	<table>
		...
		<tr>
			<td width="5%" style=""></td>
			<td width="83%" style="">DETAILS - DEBIT NOTE</td>
		</tr>
		<tr>
			<td width="3%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>#<br></span></td>
			<td width="15%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>MCA File No<br></span></td>
			<td width="12.5%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>Num.Lot<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>PO Ref.<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>Horse<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>Trailer 1<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>Trailer 2<br></span></td>
			<td width="10%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>Weight<br></span></td>
			<td width="17%" style="text-align: center; border: 1 solid black; font-weight: bold; font-size: 7px;"><span><br>License Num.<br></span></td>
		</tr>
		$dossiers_note_debit
		<br>
		<br>
		...
		<tr>
			<td width="5%" style=""></td>
			<td width="90%" style="text-align: right;">Details Debit Note No. $ref_note du $date_note</td>
			<td width="5%" style=""></td>
		</tr>
		<br>
		<br>
