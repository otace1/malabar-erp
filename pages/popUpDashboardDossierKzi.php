...
if ($_GET['type']=='DISPATCH-DELIVER') {

  $nombre_dossier = $maClasse-> nbreDispacthDeliverKzi();
  $message = '<table class="table table-dark table-hover text-nowrap table-sm">
                         <tr>
                              ...
                              <td style="border: 1px solid black;">Dispatch / Deliver Date</td>
                         </tr>
                         '.$maClasse-> afficherDispatchDeliveryKzi().'
                    </table>';

}else if ($_GET['type']=='DEPARTED FROM WISKI') {

  $nombre_dossier = $maClasse-> nbreDepartedFromWiski();
  $message = '<table class="table table-dark table-hover text-nowrap table-sm">
                         <tr>
                              <td style="border: 1px solid black;">N.</td>
                              <td style="border: 1px solid black;">MCA REF. FILE</td>
                         ...
                         '.$maClasse-> afficherDepartedWiski().'
                    </table>';
  ...
  $nombre_dossier = $maClasse-> nbreErreurDateKzi();
  $message = '<table class="table table-dark table-hover text-nowrap table-sm">
                        <tr style="font-weight: bold; background-color: black; color: white;">
                              <td style="border: 1px solid black;">N.</td>
                              <td style="border: 1px solid black;">MCA REF. FILE</td>
