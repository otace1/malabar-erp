...
if ($_GET['id_mod_lic']=='2' && $_GET['id_mod_trans']=='1' && $_GET['statut']=='AWAITING CRF/AD/INSURANCE') {
  ...
  <?php
}else if ($_GET['id_mod_lic']=='1' && ($_GET['id_mod_trans']=='3' || $_GET['id_mod_trans']=='4') && $_GET['statut']=='UNDER FORMALITIES') {
  ?>
  <tr>
    <th>MCA File REF</th>
    <th>LOT NUM.</th>
